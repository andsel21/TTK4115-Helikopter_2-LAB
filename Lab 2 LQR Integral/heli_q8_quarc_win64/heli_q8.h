...
struct P_heli_q8_T_ {
  ...
  real_T TravelCounttorad_Gain;        /* Expression: 2*pi/8192
                                        ...
                                        */
  real_T Innvertering_Gain;            /* Expression: -1
                                        * Referenced by: '<S2>/Innvertering'
                                        */
  ...
  real_T TravelTransferFcn_D;         /* Computed Parameter: TravelTransferFcn_D
                                       * Referenced by: '<S2>/Travel: Transfer Fcn'
                                       */
  real_T Innvertering2_Gain;           /* Expression: -1
                                        * Referenced by: '<S2>/Innvertering2'
                                        */
  real_T Constant_Elevation_Value;     /* Expression: 0.5
                                        * Referenced by: '<S2>/Constant_Elevation'
                                        */
