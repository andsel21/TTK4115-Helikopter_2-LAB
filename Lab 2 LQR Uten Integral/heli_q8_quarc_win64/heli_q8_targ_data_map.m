  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% heli_q8_B.Innvertering
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 14;
	
	  ;% heli_q8_B.Innvertering2
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% heli_q8_DW.VdV_PWORK.LoggedData
	  section.data(11).logicalSrcIdx = 24;
	  section.data(11).dtTransOffset = 10;
	
	  ;% heli_q8_DW.VsV_PWORK.LoggedData
  ...
  targMap.checksum0 = 1848456747;
  targMap.checksum1 = 1575609910;
  targMap.checksum2 = 864204034;
  targMap.checksum3 = 2415013034;
