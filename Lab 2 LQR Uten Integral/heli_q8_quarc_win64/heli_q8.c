 ...
 * C source code generated on : Wed Sep 23 18:59:54 2026
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (heli_q8_M->Timing.t[0] < heli_q8_P.Step_Time) {
    tmp = heli_q8_P.Step_Y0;
  } else {
    tmp = heli_q8_P.Step_YFinal;
  }
   ...
   *  Sum: '<Root>/Sum1'
   */
  heli_q8_B.Sum = (heli_q8_P.Constant2_Value + tmp) + heli_q8_B.Joystick_gain_x;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Gain: '<S4>/Gain1' */
    heli_q8_B.e_c_dot = heli_q8_P.Gain1_Gain * heli_q8_B.Joystick_gain_y;
  ...
  /* SignalConversion generated from: '<S4>/Gain2' incorporates:
   *  Gain: '<S4>/Gain'
   */
  tmp = heli_q8_P.Gain_Gain * heli_q8_B.Sum;
  for (i = 0; i < 2; i++) {
    /* Sum: '<S4>/Sum5' incorporates:
     *  Gain: '<S4>/Gain2'
     *  Gain: '<S4>/Gain3'
     *  SignalConversion generated from: '<S4>/Gain2'
     *  SignalConversion generated from: '<S4>/Gain3'
     */
    heli_q8_B.u[i] = (heli_q8_P.F[i + 2] * heli_q8_B.e_c_dot + heli_q8_P.F[i] *
                      tmp) - (heli_q8_P.K[i + 4] *
      heli_q8_B.ElevationTransferFcn + (heli_q8_P.K[i + 2] *
   ...
   */
  heli_q8_B.V_s = heli_q8_B.u[0] + heli_q8_P.v_s0;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Gain: '<S2>/Travel: Count to rad' */
    heli_q8_B.TravelCounttorad = heli_q8_P.TravelCounttorad_Gain *
      rtb_HILReadEncoderTimebase_o1;

    /* Gain: '<S2>/Innvertering' */
    heli_q8_B.Innvertering = heli_q8_P.Innvertering_Gain *
      heli_q8_B.TravelCounttorad;
  }

  /* Gain: '<S2>/Innvertering2' incorporates:
   *  TransferFcn: '<S2>/Travel: Transfer Fcn'
   */
  heli_q8_B.Innvertering2 = (heli_q8_P.TravelTransferFcn_C *
    heli_q8_X.TravelTransferFcn_CSTATE + heli_q8_P.TravelTransferFcn_D *
    heli_q8_B.TravelCounttorad) * heli_q8_P.Innvertering2_Gain;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Sum: '<S2>/Sum' incorporates:
     *  Constant: '<S2>/Constant_Elevation'
     */
    heli_q8_B.Sum_o = heli_q8_B.ElevationCounttorad -
      heli_q8_P.Constant_Elevation_Value;

    /* SignalConversion generated from: '<Root>/To File' */
    rtb_TmpSignalConversionAtToFile[0] = heli_q8_B.Sum;
    rtb_TmpSignalConversionAtToFile[1] = heli_q8_B.u[1];
    rtb_TmpSignalConversionAtToFile[2] = heli_q8_B.V_s;
    rtb_TmpSignalConversionAtToFile[3] = heli_q8_B.Innvertering;
    rtb_TmpSignalConversionAtToFile[4] = heli_q8_B.Innvertering2;
    rtb_TmpSignalConversionAtToFile[5] = heli_q8_B.PitchCounttorad;
    rtb_TmpSignalConversionAtToFile[6] = heli_q8_B.PitchTransferFcn;
    rtb_TmpSignalConversionAtToFile[7] = heli_q8_B.Sum_o;
    rtb_TmpSignalConversionAtToFile[8] = heli_q8_B.ElevationTransferFcn;

    /* ToFile: '<Root>/To File' */
    if (rtmIsMajorTimeStep(heli_q8_M)) {
      if (rtmIsMajorTimeStep(heli_q8_M) ) {
        {
          if (!(++heli_q8_DW.ToFile_IWORK.Decimation % 2) &&
              (heli_q8_DW.ToFile_IWORK.Count * (9 + 1)) + 1 < 100000000 ) {
            ...
            if (fp != (NULL)) {
              ...
              if (fwrite(u, sizeof(real_T), 9 + 1, fp) != 9 + 1) {
                rtmSetErrorStatus(heli_q8_M,
                                  "Error writing to MAT-file LQR17.mat");
                return;
              }

              if (((++heli_q8_DW.ToFile_IWORK.Count) * (9 + 1))+1 >= 100000000)
              {
                (void)fprintf(stdout,
                              "*** The ToFile block will stop logging data before\n"
                              "    the simulation has ended, because it has reached\n"
                              "    the maximum number of elements (100000000)\n"
                              "    allowed in MAT-file LQR17.mat.\n");
              }
            }
          }
        }
   ...
   *  Sum: '<S1>/Add'
   */
  tmp = (heli_q8_B.V_s - heli_q8_B.u[1]) * heli_q8_P.Frontgain_Gain;

  /* Saturate: '<S2>/Front motor: Saturation' */
  if (tmp > heli_q8_P.FrontmotorSaturation_UpperSat) {
    /* Saturate: '<S2>/Front motor: Saturation' */
    heli_q8_B.FrontmotorSaturation = heli_q8_P.FrontmotorSaturation_UpperSat;
  } else if (tmp < heli_q8_P.FrontmotorSaturation_LowerSat) {
    /* Saturate: '<S2>/Front motor: Saturation' */
    heli_q8_B.FrontmotorSaturation = heli_q8_P.FrontmotorSaturation_LowerSat;
  } else {
    /* Saturate: '<S2>/Front motor: Saturation' */
    heli_q8_B.FrontmotorSaturation = tmp;
  }
   ...
   *  Sum: '<S1>/Subtract'
   */
  tmp = (heli_q8_B.V_s + heli_q8_B.u[1]) * heli_q8_P.Backgain_Gain;

  /* Saturate: '<S2>/Back motor: Saturation' */
  if (tmp > heli_q8_P.BackmotorSaturation_UpperSat) {
    /* Saturate: '<S2>/Back motor: Saturation' */
    heli_q8_B.BackmotorSaturation = heli_q8_P.BackmotorSaturation_UpperSat;
  } else if (tmp < heli_q8_P.BackmotorSaturation_LowerSat) {
    /* Saturate: '<S2>/Back motor: Saturation' */
    heli_q8_B.BackmotorSaturation = heli_q8_P.BackmotorSaturation_LowerSat;
  } else {
    /* Saturate: '<S2>/Back motor: Saturation' */
    heli_q8_B.BackmotorSaturation = tmp;
  }
...
void heli_q8_initialize(void)
{
  ...
  {
    FILE *fp = (NULL);
    char fileName[509] = "LQR17.mat";
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M, "Error creating .mat file LQR17.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp, 9 + 1, 0, "ans")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file LQR17.mat");
      return;
    }
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File' */
  {
    ...
    if (fp != (NULL)) {
      char fileName[509] = "LQR17.mat";
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M, "Error closing MAT-file LQR17.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M, "Error reopening MAT-file LQR17.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 9 + 1, heli_q8_DW.ToFile_IWORK.Count, "ans"))
      {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for ans to MAT-file LQR17.mat");
      }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (1848456747U);
  heli_q8_M->Sizes.checksums[1] = (1575609910U);
  heli_q8_M->Sizes.checksums[2] = (864204034U);
  heli_q8_M->Sizes.checksums[3] = (2415013034U);
...

  {
    ...
    heli_q8_B.Innvertering = 0.0;
    heli_q8_B.Innvertering2 = 0.0;
    heli_q8_B.Sum_o = 0.0;
